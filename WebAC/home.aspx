                    ...
                    <div class="card">
                        ...
                        <div id="step-1" class="stack">
                            ...
                            <div class="row filters-row">
                                <div class="w-3">
                                    <label>Gerencia</label>
                                    <select id="sel-gerencia" class="form-select">
                                        <option value="">Todas las gerencias</option>
                                    </select>
                                </div>
                                <div class="w-3">
                                    <label>Superintendencia</label>
                                    <select id="sel-superintendencia" class="form-select">
                                        <option value="">Todas las superintendencias</option>
                                    </select>
                                </div>
                                <div class="w-3">
                                    <label>Unidad de Proceso</label>
                                    <select id="sel-unidad-proceso" class="form-select">
                        ...
                        <div id="step-2" class="stack hidden">
                            ...
                            <!-- FILTROS JERÁRQUICOS PERSISTENTES -->
                            <div class="row filters-row" style="margin-bottom: 1rem;">
                                <div class="w-3">
                                    <label>Gerencia</label>
                                    <select id="step2-gerencia" class="form-select">
                                        <option value="">Todas las gerencias</option>
                                    </select>
                                </div>
                                <div class="w-3">
                                    <label>Superintendencia</label>
                                    <select id="step2-superintendencia" class="form-select">
                                        <option value="">Todas las superintendencias</option>
                                    </select>
                                </div>
                                <div class="w-3">
                                    <label>Unidad de Proceso</label>
                                    <select id="step2-unidad-proceso" class="form-select">
                                        <option value="">Todas las unidades</option>
                                    </select>
                                </div>
                                <div class="w-3" style="display: flex; align-items: end;">
                                    <button class="btn icon" id="reset-hierarchy-filters" aria-label="Limpiar filtros jerárquicos" title="Limpiar filtros jerárquicos">🗑️</button>
                                </div>
                            </div>
