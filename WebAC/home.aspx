...
<head>
    ...
    <link rel="stylesheet" href="SiteAssets/AppAC/css/style.css" />
</head>
<body>
        ...
        <main class="main">
            ...
            <div class="container">
                    ...
                    <div class="grid kpi kpi-tiles">
                        <div class="card metric-card" id="card-flotas">
                            ...
                            <div class="metric-row">
                                <span class="metric-up" id="kpi-flotas-pct">▲ 0%</span>
                                <span class="metric-sub">% cubierto</span>
                            </div>
                            <div class="metric-row danger">
                                <span class="metric-down" id="kpi-flotas-pend">▼ 0</span>
                        ...
                        <div class="card metric-card" id="card-procesos">
                            ...
                            <div class="metric-row">
                                <span class="metric-up" id="kpi-procesos-pct">▲ 0%</span>
                                <span class="metric-sub">% cubierto</span>
                            </div>
                            <div class="metric-row danger">
                                <span class="metric-down" id="kpi-procesos-pend">▼ 0</span>
                                <span class="metric-sub">por analizar</span>
                            </div>
                        </div>
                        <div class="card metric-card" id="card-egis">
                            ...
                            <div class="metric-row">
                                <span class="metric-up" id="kpi-egi-pct">▲ 0%</span>
                                <span class="metric-sub">% cubierto</span>
                            </div>
                            <div class="metric-row danger">
                                <span class="metric-down" id="kpi-egi-pend">▼ 0</span>
                                <span class="metric-sub">por analizar</span>
                            </div>
                        </div>
                        <div class="card metric-card" id="card-equipos">
                            ...
                            <div class="metric-row">
                                <span class="metric-up" id="kpi-equipos-pct">▲ 0%</span>
                                <span class="metric-sub">% cubierto</span>
                            </div>
                            <div class="metric-row danger">
                                <span class="metric-down" id="kpi-equipos-pend">▼ 0</span>
                                <span class="metric-sub">por analizar</span>
                            </div>
                        </div>
                    </div>
                ...
                <section id="view-dashboard-advanced" class="view active">
                    <div class="card adv-filters-card" style="margin-bottom: 1rem;">
                        <div class="row adv-filters">
                            ...
                            <button class="btn adv-clear-filters-btn" id="adv-clear-filters" title="Limpiar filtros" aria-label="Limpiar filtros">🗑️</button>
                        </div>
                    </div>
                    <div class="grid kpi kpi-tiles kpi-7">
                        <div class="card metric-card" id="adv-card-gerencia">
                            ...
                            <div class="metric-row">
                                <span class="metric-up" id="adv-gerencia-pct">▲ 0%</span>
                                <span class="metric-sub">% cubierto</span>
                            </div>
                            <div class="metric-row danger">
                                <span class="metric-down" id="adv-gerencia-cov-pend">▼ 0</span>
                                <span class="metric-sub">por analizar</span>
                            </div>
                        </div>
                        <div class="card metric-card" id="adv-card-super">
                            ...
                            <div class="metric-row">
                                <span class="metric-up" id="adv-super-pct">▲ 0%</span>
                                <span class="metric-sub">% cubierto</span>
                            </div>
                            <div class="metric-row danger">
                                <span class="metric-down" id="adv-super-cov-pend">▼ 0</span>
                                <span class="metric-sub">por analizar</span>
                            </div>
                        </div>
                        <div class="card metric-card" id="adv-card-unidad">
                            ...
                            <div class="metric-row">
                                <span class="metric-up" id="adv-unidad-pct">▲ 0%</span>
                                <span class="metric-sub">% cubierto</span>
                            </div>
                            <div class="metric-row danger">
                                <span class="metric-down" id="adv-unidad-cov-pend">▼ 0</span>
                                <span class="metric-sub">por analizar</span>
                            </div>
                        </div>
                        <div class="card metric-card" id="adv-card-flotas">
                            ...
                            <div class="metric-row">
                                <span class="metric-up" id="adv-kpi-flotas-pct">▲ 0%</span>
                                <span class="metric-sub">% cubierto</span>
                            </div>
                            <div class="metric-row danger">
                                <span class="metric-down" id="adv-kpi-flotas-pend">▼ 0</span>
                                <span class="metric-sub">por analizar</span>
                            </div>
                        </div>
                        <div class="card metric-card" id="adv-card-procesos">
                            ...
                            <div class="metric-row">
                                <span class="metric-up" id="adv-kpi-procesos-pct">▲ 0%</span>
                                <span class="metric-sub">% cubierto</span>
                            </div>
                            <div class="metric-row danger">
                                <span class="metric-down" id="adv-kpi-procesos-pend">▼ 0</span>
                                <span class="metric-sub">por analizar</span>
                            </div>
                        </div>
                        <div class="card metric-card" id="adv-card-egis">
                            ...
                            <div class="metric-row">
                                <span class="metric-up" id="adv-kpi-egi-pct">▲ 0%</span>
                                <span class="metric-sub">% cubierto</span>
                            </div>
                            <div class="metric-row danger">
                                <span class="metric-down" id="adv-kpi-egi-pend">▼ 0</span>
                                <span class="metric-sub">por analizar</span>
                            </div>
                        </div>
                        <div class="card metric-card" id="adv-card-equipos">
                            ...
                            <div class="metric-row">
                                <span class="metric-up" id="adv-kpi-equipos-pct">▲ 0%</span>
                                <span class="metric-sub">% cubierto</span>
                            </div>
                            <div class="metric-row danger">
                                <span class="metric-down" id="adv-kpi-equipos-pend">▼ 0</span>
                                <span class="metric-sub">por analizar</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card" style="margin-top: 1rem;">
                        <div class="toolbar tight" style="margin-bottom: 0.6rem;">
                            ...
                            <div class="inline">
                                <button class="btn" id="dash-eval-prev" aria-label="Página anterior">«</button>
                                <input id="dash-eval-page" type="number" min="1" class="page-input" />
                                <span class="muted" id="dash-eval-page-total"></span>
                                <button class="btn" id="dash-eval-next" aria-label="Página siguiente">»</button>
                ...
                <div class="modal-backdrop" id="criticidad-modal" aria-hidden="true">
                    <div class="modal" role="dialog" aria-modal="true" aria-labelledby="criticidad-modal-title">
                        <div class="modal-header">
                            ...
                            <button class="icon-btn" type="button" id="criticidad-modal-close" aria-label="Cerrar">×</button>
                        </div>
                ...
                <section id="view-wizard" class="view">
                    <div class="card">
                        <div class="stepper" id="wizard-steps">
                            ...
                            <div class="step">2. Selección</div>
                        ...
                        <div id="step-2" class="stack hidden">
                            <div class="step-header">
                                ...
                                <div class="step-actions">
                                    <button class="btn" id="back-step-1">Atrás</button>
                            ...
                            <div class="row filters-row">
                                ...
                                <div class="w-3 filter-actions">
                                    <label>&nbsp;</label>
                                    <button class="btn icon" id="reset-filters" aria-label="Limpiar filtros" title="Limpiar filtros">✕</button>
                                </div>
                            </div>
                            ...
                            <div id="equipo-search" class="stack hidden">
                                ...
                                <div id="equipo-existente" class="alert warning hidden">
                                    <div class="inline" style="justify-content:space-between; width:100%;">
                                        ...
                                        <button class="btn" id="ver-evaluacion-existente">Ver análisis</button>
                                    </div>
                                </div>
                                <div class="toolbar">
                                    ...
                                    <div class="spacer"></div>
                                    <div class="inline">
                                        <button class="btn" id="equipo-prev" aria-label="Página anterior">«</button>
                                        <input id="equipo-page" type="number" min="1" class="page-input" />
                                        <span class="muted" id="equipo-page-total"></span>
                                        <button class="btn" id="equipo-next" aria-label="Página siguiente">»</button>
                                    </div>
                                </div>
                        ...
                        <div id="step-3" class="stack hidden">
                            <div class="step-header">
                                ...
                                <div class="spacer"></div>
                                <div class="step-actions">
                                    <button class="btn" id="back-step-2">Atrás</button>
                                    <button class="btn primary" id="to-step-4" disabled>Continuar</button>
                                </div>
                            </div>
                            <div class="muted">Debe seleccionar un escenario para continuar con el análisis de criticidad.</div>
                            <div class="muted">Equipos cubiertos (jerarquía): <span id="equipo-count-target">-</span></div>
                            <div>
                                <label>Buscar escenario</label>
                                <input id="escenario-search" placeholder="Buscar por código o texto" />
                            </div>
                            <div class="toolbar">
                                <span class="muted" id="escenario-count"></span>
                                <div class="spacer"></div>
                                <div class="inline">
                                    <button class="btn" id="escenario-prev" aria-label="Página anterior">«</button>
                                    <input id="escenario-page" type="number" min="1" class="page-input" />
                                    <span class="muted" id="escenario-page-total"></span>
                                    <button class="btn" id="escenario-next" aria-label="Página siguiente">»</button>
                                </div>
                            </div>
                        ...
                        <div id="step-4" class="stack hidden">
                            <div class="step-header">
                                ...
                                <div class="spacer"></div>
                                <div class="step-actions">
                                    <button class="btn" id="back-step-3">Atrás</button>
                            ...
                            <div>
                                ...
                                <textarea id="justificacion" placeholder="Describa la justificación"></textarea>
                            </div>
                        </div>
                        ...
                        <div id="step-5" class="stack hidden">
                            <div class="step-header">
                                ...
                                <div class="spacer"></div>
                                <div class="step-actions">
                                    <button class="btn" id="back-step-4">Atrás</button>
                        ...
                        <div id="step-6" class="stack hidden">
                            <div class="alert success">Análisis de criticidad guardado correctamente.</div>
                            <div>
                                <button class="btn" id="nueva-otra">Nuevo análisis de criticidad</button>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section id="view-mis" class="view">
                    <div class="card">
                        <div class="toolbar">
                            <div class="section-title">Mis Análisis</div>
                            <div class="spacer"></div>
                        ...
                        <div class="toolbar" style="margin-bottom: 0.6rem;">
                            ...
                            <div class="spacer"></div>
                            <div class="inline">
                                <button class="btn" id="mis-eval-prev" aria-label="Página anterior">«</button>
                                <input id="mis-eval-page" type="number" min="1" class="page-input" />
                                <span class="muted" id="mis-eval-page-total"></span>
                                <button class="btn" id="mis-eval-next" aria-label="Página siguiente">»</button>
                            </div>
                        </div>
                ...
                <section id="view-all" class="view">
                    <div class="card">
                        <div class="toolbar">
                            <div class="section-title">Todos los análisis</div>
                            <div class="spacer"></div>
                        ...
                        <div class="toolbar" style="margin-bottom: 0.6rem;">
                            ...
                            <div class="spacer"></div>
                            <div class="inline">
                                <button class="btn" id="all-eval-prev" aria-label="Página anterior">«</button>
                                <input id="all-eval-page" type="number" min="1" class="page-input" />
                                <span class="muted" id="all-eval-page-total"></span>
                                <button class="btn" id="all-eval-next" aria-label="Página siguiente">»</button>
                            </div>
                        </div>
                ...
                <section id="view-admin" class="view">
                    <div class="card">
                        <div class="toolbar">
                            <div class="section-title">Solicitudes de edición</div>
                            <div class="spacer"></div>
                    ...
                    <div class="card" style="margin-top: 1rem;">
                        <div class="toolbar">
                            <div class="section-title">Admin - Análisis</div>
                            <div class="spacer"></div>
                        ...
                        <div class="toolbar" style="margin-bottom: 0.6rem;">
                            ...
                            <div class="spacer"></div>
                            <div class="inline">
                                <button class="btn" id="admin-eval-prev" aria-label="Página anterior">«</button>
                                <input id="admin-eval-page" type="number" min="1" class="page-input" />
                                <span class="muted" id="admin-eval-page-total"></span>
                                <button class="btn" id="admin-eval-next" aria-label="Página siguiente">»</button>
                            </div>
                        </div>
                ...
                <section id="view-evaluacion" class="view">
                    <div class="card">
                        <div class="toolbar">
                            <div class="section-title" id="eval-detalle-title">Análisis</div>
                            <div class="spacer"></div>
                            <button class="btn" id="eval-request-edit">Solicitar edición</button>
                    ...
                    <div class="card hidden" style="margin-top: 1rem;" id="eval-edit-card">
                        <div class="section-title">Editar análisis</div>
                    ...
                    <div class="card" style="margin-top: 1rem;">
                        ...
                        <div class="toolbar">
                            ...
                            <button class="btn" id="eval-equipos-next">»</button>
                        </div>
    ...
    <script src="SiteAssets/AppAC/js/spHttp.js"></script>
    <script src="SiteAssets/AppAC/js/catalogService.js"></script>
    <script src="SiteAssets/AppAC/js/scenarioService.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    <script src="https://cdn.jsdelivr.net/npm/chart.js@4.4.1/dist/chart.umd.min.js"></script>
    <script src="SiteAssets/AppAC/js/matrixModal.js"></script>
    <script src="SiteAssets/AppAC/js/app.js"></script>
</body>
</html>
-->
<!-- DUPLICATE BLOCK START
                    ...
                    <div class="grid dash-bottom" style="margin-top: 1.2rem;">
                        <div class="card">
                            <div class="section-title">Análisis por gerencia (equipos cubiertos)</div>
                            <div class="geo-grid">
                        ...
                        <div class="card classif-card">
                            <div class="section-title">Clasificación por Criticidad</div>
                            <div class="chart-center">
                ...
                <section id="view-dashboard-advanced" class="view active">
                    <div class="card" style="margin-bottom: 1rem;">
                        <div class="row adv-filters">
                            <div>
                                <label>Gerencia</label>
                                <input id="adv-gerencia" placeholder="Buscar..." />
                            </div>
                            <div>
                                <label>Superintendencia</label>
                                <input id="adv-superintendencia" placeholder="Buscar..." />
                            </div>
                            <div>
                                <label>UnidadProceso</label>
                                <input id="adv-unidad" placeholder="Buscar..." />
                            </div>
                            <div>
                                <label>Fleet</label>
                                </body>
    ...
    <script src="SiteAssets/AppAC/js/app.js"></script>
        ...
        <section id="view-dashboard-advanced" class="view active">
            ...
            <div class="grid kpi kpi-tiles" style="margin-top: 0.8rem;">
                <div class="card metric-card">
                    <div class="metric-title">Cobertura Gerencia</div>
                    <div class="metric-value" id="adv-gerencia-cov">-</div>
                    <div class="metric-sub" id="adv-gerencia-cov-desc">-</div>
                </div>
                <div class="card metric-card">
                    <div class="metric-title">Cobertura Superintendencia</div>
                    <div class="metric-value" id="adv-super-cov">-</div>
                    <div class="metric-sub" id="adv-super-cov-desc">-</div>
                </div>
                <div class="card metric-card">
                    <div class="metric-title">Cobertura UnidadProceso</div>
                    <div class="metric-value" id="adv-unidad-cov">-</div>
                    <div class="metric-sub" id="adv-unidad-cov-desc">-</div>
                </div>
            </div>
